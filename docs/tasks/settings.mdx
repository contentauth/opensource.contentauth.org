...
import JsSettings from './js/_js-settings.md';
...
- `Settings` is a declarative configuration for the SDK that you can load from a JSON file or set programmatically.
- `Context` controls how `Reader`, `Builder`, and other components operate, including:
