...
**Asset**: A digital media file or stream of data of [certain specific image, video, or audio formats](../c2pa-rs/docs/supported-formats.md). A _composed asset_ generalizes this concept, for example an image superimposed on top of another image.
