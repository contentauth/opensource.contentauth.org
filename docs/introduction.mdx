...
- [**The Rust library**](sdk-repos/c2pa-rs/readme.md) that generates the other language bindings and can also be used directly to read and generate manifest data. The Rust library is the fundamental system underlying everything else.
- [**C2PA Tool**](sdk-repos/c2pa-rs/cli/readme.md), a command-line tool for working with manifests and media. This tool is a wrapper around the Rust SDK and provides most of the same capabilities that it does. C2PA Tool can:
