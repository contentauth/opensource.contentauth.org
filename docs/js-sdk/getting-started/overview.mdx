...
The SDK strives to maintain compliance with the [C2PA specification](https://c2pa.org/specifications/specifications/1.1/specs/C2PA_Specification.html) as much as possible, and the web components follow the [C2PA user experience guidance](https://c2pa.org/specifications/specifications/1.1/ux/UX_Recommendations.html) recommendations.

### Security and encryption

The SDK handles all [validation](https://c2pa.org/specifications/specifications/1.1/specs/C2PA_Specification.html#_validation)
