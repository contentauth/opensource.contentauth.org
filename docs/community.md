...
- [**C2PA Security testing tool**](https://github.com/contentauth/c2pa-attacks): A CLI tool derived from [C2PA Tool](./sdk-repos/c2patool/readme.md) that performs security testing on a Content Credentials application.  This tool is intended for use by software security professionals.
