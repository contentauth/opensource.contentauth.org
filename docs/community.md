...
- **JavaScript library**: [c2pa-js](https://github.com/contentauth/c2pa-js), a monorepo containing CAI JavaScript libraries and tools
  - **Browser JavaScript**: [c2pa-web](https://github.com/contentauth/c2pa-js/tree/main/packages/c2pa-web)
...
- [**C2PA Security testing tool**](https://github.com/contentauth/c2pa-attacks): A CLI tool derived from [C2PA Tool](./sdk-repos/c2pa-rs/cli/readme.md) that performs security testing on a Content Credentials application.  This tool is intended for use by software security professionals.

### External projects

These projects are entirely community-driven, and the CAI team doesn't endorse, maintain, or support them.

:::warning
CAI has not vetted and does not endorse these third-party projects.
