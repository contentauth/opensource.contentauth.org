...
You now have all the needed information to configure C2PA Tool for manifest signing. Edit your [manifest store file](../c2pa-rs/cli/docs/manifest.md) to add the following fields that are specific to C2PA Tool:
...
You can now use C2PA Tool [to add a manifest to an image or other asset file](../c2pa-rs/cli/docs/usage.md#adding-a-manifest-to-an-asset-file). The command will be something like this:
