...
Because using a KMS can be complex, you may want to start by using a local "mock" service (such as LocalStack for Amazon KMS) as illustrated in the [c2pa-python-example](sdk-repos/c2pa-python-example/readme.md#using-localstack). Doing this enables you to test your code before you set up a production KMS.
...
The [c2pa-python-example](sdk-repos/c2pa-python-example/readme.md) app provides an example of constructing a certificate signing request (CSR) and of using [Amazon KMS](https://aws.amazon.com/kms/).
