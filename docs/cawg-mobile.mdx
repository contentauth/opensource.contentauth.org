...
While a C2PA manifest answers the question: "What device or app produced this file, and what happened to it?" a creator assertion answers the question: "Who is the person or organization behind this file, and what do they permit?"

The C2PA claim is signed by the capturing app or device. A creator assertion is a second claim signed by a credential belonging to the creator. Both the C2PA and CAWG signatures end up in the same manifest, and a validating app can verify them independently.
